...
> 本站：`test0721-marketing` · 頁面錨點 `#travel`  
> 配圖：[gimi-illustration-skill](https://github.com/GiMi-Xiaomi/gimi-illustration-skill) · quirky-sketch · IP **gimi** · 繁體標註  
> 圖檔：`static/assets/travel-memory/` · 策略單：`gimi-illustration-skill/outputs/20260719-travel-agent-memory/shot-config.md`
...
![記憶對話閉環](static/assets/travel-memory/01-memory-loop.jpg)
...
![棧遷移：模式相同](static/assets/travel-memory/02-stack-adapt.jpg)
...
![偏好按 user 隔離](static/assets/travel-memory/03-user-isolation.jpg)
